...
const HomePage: React.FC = () => {
	const [selectionOptionState, setSelectionOptionState] = useState("boards")
		...
		<>
			<Box sx={{ display: "grid", placeItems: "center", height: "100vh" }}>
				<div>
					<div>
						<Button
							sx={{ mr: 2, mb: 4, p: 2, border: "1px solid rgba(121, 121, 121, 0.7)" }}
							onClick={() => setSelectionOptionState("boards")}
						>
							Select A Board By ID
						</Button>
						<Button
							sx={{ ml: 2, mb: 4, p: 2, border: "1px solid rgba(121, 121, 121, 0.7)" }}
